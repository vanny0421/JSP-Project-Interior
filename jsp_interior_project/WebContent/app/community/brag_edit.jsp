...
<body class="is-preload">
	...
	<c:set var="brag_board" value="${brag_board}" />
	<!-- Page Wrapper -->
	<div id="page-wrapper">
		...
		<div id="wrapper">
			...
			<div id="div_write">
			<!-- form 태그 시작 -->
			<form action="${pageContext.request.contextPath}/Brag/Brag_EditOk.br?user_id=${session_id}" name="writeForm" method="post" enctype="multipart/form-data">
				<input type="hidden" name="brag_board_no" value="${brag_board.getBrag_board_no()}">
				<table id="div_table">
					<tr>
						<!-- <td><select id="board_select" name="brag_board_select" fw-filter="isFill"
						...
						<th scope="row"><input id="board_title" name="brag_board_title"
							type="text" placeholder="제목 입력" value="${brag_board.getBrag_board_title()}"></th>
					</tr>
				...
				<table border="1">
					...
					<tbody>
						<tr style="border-top: none; border-bottom: none;">
							<td colspan="2" class="clear"><textarea
									style="width: 100%; display: none;" name="brag_board_content" id="content"
					...
					<tbody class="">
						...
						<tr>
							...
							<td>
								<input id="brag_board_file4" name="board_file4" type="file"> 
				...
				<ul>
					<li><input id="view_list" type="button" value="목록"
						class="primary"
						onclick="location.href='${pageContext.request.contextPath}/Brag/Brag_BoardList.bo'" /></li>
	...
	<script>
		function changeTitle() {
			...
			/* var select = document.getElementById('brag_board_select'); */
			var title = document.getElementById('brag_board_title');

			title.value = "[" + select.value + "] ";
		}
	</script><input type="hidden" name="brag_board_no" value="<%-- ${cs_board.getCs_board_no()} --%>">
