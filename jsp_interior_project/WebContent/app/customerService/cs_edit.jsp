...
<body class="is-preload">
	...
	<c:set var="cs_board" value="${cs_board}" />
	<!-- Page Wrapper -->
	<div id="page-wrapper">
		...
		<div id="wrapper">
			...
			<div id="div_write">
			<!-- form 태그 시작 -->
			<form action="${pageContext.request.contextPath}/customerService/CS_EditOk.bo?user_id=${session_id}" name="writeForm" method="post" enctype="multipart/form-data">
				<input type="hidden" name="cs_board_no" value="${cs_board.getCs_board_no()}">
				<table id="div_table">
					<tr>
						<td><select id="board_select" name="cs_board_select" fw-filter="isFill"
						...
						<th scope="row"><input id="board_title" name="cs_board_title"
							type="text" placeholder="제목 입력" value="${cs_board.getCs_board_title()}"></th>
					</tr>
					...
					<tbody class="">
						<tr>
							...
							<td>
								...
								<input type="button" onclick="cancelFile('cs_board_file1')" value="첨부 삭제">
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<input type="button" onclick="cancelFile('cs_board_file2')" value="첨부 삭제">
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<input type="button" onclick="cancelFile('cs_board_file3')" value="첨부 삭제">
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<input type="button" onclick="cancelFile('cs_board_file4')" value="첨부 삭제">
							</td>
						</tr>
						<tr>
							...
							<td>
								...
								<input type="button" onclick="cancelFile('cs_board_file5')" value="첨부 삭제">
							</td>
						</tr>
					</tbody>
					<tbody>
	...
	<script>
		function changeTitle() {
			...
			var select = document.getElementById('cs_board_select');
			var title = document.getElementById('cs_board_title');

			title.value = "[" + select.value + "] ";
		}
	</script><input type="hidden" name="cs_board_no" value="<%-- ${cs_board.getCs_board_no()} --%>">
