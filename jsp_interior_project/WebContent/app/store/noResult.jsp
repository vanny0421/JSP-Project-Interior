...
<body class="is-preload">
	...
	<div id="page-wrapper">
		...
		<!-- Wrapper -->
		<div id="wrapper">
					<h2 style="text-align: center; border-bottom: none; padding-bottom: 0;">검색 결과가 없습니다.</h2>
					<section id="main" class="main" style="text-align: center; border-bottom: none;">
					<img style="width: 600px;" class="fit-picture" src="${pageContext.request.contextPath}/images/sadness.jpg">
				</section>
		</div>
	</div>
