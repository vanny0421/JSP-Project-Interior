...
<body class="is-preload">
	...
	<div id="page-wrapper">
		...
		<div class="swiper-container" style="width: 100%; height:600px; border: none;">
			<div class="swiper-wrapper">
				<div class="swiper-slide">
					<img src="${pageContext.request.contextPath }/images/photo10.jpg"
						width="100%;">
				</div>
				<div class="swiper-slide">
					<img src="${pageContext.request.contextPath }/images/photo9.jpg"
						width="100%;">
				</div>
				<div class="swiper-slide">
				...
				<div class="swiper-slide">
					<img src="${pageContext.request.contextPath }/images/photo12.jpg"
						width="100%;">
				</div>
		...
		<div class="navbar">
			<div class="dropdown">
				<button class="dropbtn">
					소품 분류<i class="fa fa-caret-down"></i>
				</button>
				<div class="dropdown-content">

					<div class="row">
						<div class="column">
							<a href="${pageContext.request.contextPath }/store/Props.st?PRODUCT_SUBCATEGORY=Home">Home & Decor</a>
							 <a href="${pageContext.request.contextPath }/store/Props.st?PRODUCT_SUBCATEGORY=Sleep">Sleep Shop</a> 
							 <a href="${pageContext.request.contextPath }/store/Props.st?PRODUCT_SUBCATEGORY=Toys">Toys</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div style="text-align: left; margin-left: 20%;">
			<header>
				<h3 style="margin-top: 5%;">베스트상품</h3>
			</header>
		</div>
		...
		<div style="text-align: left; margin-left: 15%;">
			<header>
				<h3 style="margin-top: 8%;">소품 shop</h3>
			...
			<div class="t2-wrapper">
				<c:forEach var="propsList" items="${StoreList}">
					<div class="t2">
						<div class="bigger">
							<a
								href="${pageContext.request.contextPath }/store/productView.st?product_no=${propsList.getProduct_no()}">
								<span><img class="image"
									src="${pageContext.request.contextPath }/storeImages/${propsList.getProduct_img()}"/></span>
							</a>
							<div class="exBox" style="width:200px; margin: auto;">
								<a
									href="${pageContext.request.contextPath }/store/productView.st?product_no=${propsList.getProduct_no()}">${propsList.getProduct_name() }</a>
							</div>
						</div>
					</div>
				</c:forEach>
		...
		<table>
						<tr align="center" valign="middle">
							<td>
							<c:if test="${nowPage > 1}">
								<a href="${pageContext.request.contextPath}/store/Props.st?page=${nowPage-1}">&lt;</a>
							</c:if>
							<c:forEach var="i" begin="${startPage}" end="${endPage}">
								<c:choose>
									...
									<c:otherwise>
										<a href="${pageContext.request.contextPath}/store/Props.st?page=${i}"><c:out value="${i}"/></a>
									</c:otherwise>
								</c:choose>
							</c:forEach>
